...
$a=(mt_rand(1,147));
$sql = "SELECT * FROM pokemon WHERE pkmn_index ='$a'";
...
<html>
	<head>
		<link rel="stylesheet" type="text/css" href="css_pkmn.css">
		<title>HANGMAN</title>
	</head>
<body>
...
function showinfo()
{
	document.getElementById("pkmnname").innerHTML = 
	"<h1><?php echo $name;?></h1>";
	...
	'<br/> <img src="pokemon/kantosprites/<?php echo $name;?>.gif">';
	document.getElementById("linkk").innerHTML =
	'<a href="<?php echo $linkk;?>">PokeDex</a>';
}
